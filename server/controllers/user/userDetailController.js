...
const getSearchUsers = async (req, res) => {
  ...
  const users = await User.find(query).select('name userName pfp');
...
export{getAllUsers ,updateProfile,updateUserPfp,removeUserPfp,updateUserHeader,removeUserHeader,getSearchUsers}
